...
class start(ttk.Frame):
    ...
    def confirm(self):
        ...
        if selected_mode == "First Degree Conversion(FDC1)":
            ...
            #first_degree_interface(master, img_path)
        elif selected_mode == "Final Degree Conversion(FDC2)":
            ttk.dialogs.dialogs.Messagebox.show_info(message="Function under development. Stay tuned!", title="Final Degree Conversion Module")
